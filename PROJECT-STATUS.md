...
_None — M6 done. Next milestone (M7: Quarters table + first-quarter calculation logic + display in Priorities List header, including Subsystem 10 `ensureCurrentQuarter` middleware) is ready to start when owner is._
