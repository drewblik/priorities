...
_None — M7 done. Next milestone (M8: Tasks + Events tables + manual CRUD via Priority Detail, including Subsystem 12 recurrence schema) is ready to start when owner is._
