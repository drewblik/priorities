...
_None — M8 done. Next milestone (M9: Daily View page — today's Tasks + Events with checkboxes and date navigation, finally rendering the recurrence engine's virtual instances against today) is ready to start when owner is._
